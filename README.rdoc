...
to illustrate Behavior Driven Development and Cubumber/Capybara testing.
You can copy this directory to your Cloud9 wokspace by first forking the SELT/BDDexample
